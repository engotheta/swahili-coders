...
Route::middleware(['auth','checked','cors'])->prefix('cms')->name('cms.')->group(function(){
    ...
    Route::resource('communities', 'cms\CommunitiesController');

    Route::post('communities-upload', 'cms\CommunitiesController@uploadCommunities')->name('communities.upload');

    Route::resource('community-categories', 'cms\CommunitiesCategoriesController');
    ...
    Route::resource('projects', 'cms\projectsController');
