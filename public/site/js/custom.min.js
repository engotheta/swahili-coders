...
$(document).ready(function(){
  ...
  let scroll_anchors = document.querySelectorAll('.scroll-anchor');
  scroll_anchors.forEach(anchor => anchor.dataset.anchor && anchor.addEventListener('click',()=>{
    document.querySelector(anchor.dataset.anchor).scrollIntoView( {behavior: "smooth" })
  }))
