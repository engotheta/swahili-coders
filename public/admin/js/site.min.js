...
function togglemenu() {
    ...
    0 == $(".site-navbar").hasClass("theme-horizontal") && (e <= 1200 && e >= 992 && $(".site-navbar").addClass("navbar-collapsed"), e < 992 && $(".site-navbar").removeClass("navbar-collapsed"))
}
...
$(document).ready(function() {
    ...
    if ($('[data-toggle="tooltip"]').tooltip(), $('[data-toggle="popover"]').popover(), $(".to-do-list input[type=checkbox]").on("click", function() {
            ...
            $(".site-navbar").toggleClass("navbar-collapsed")
            ...
            var e = $(this).val().toLowerCase(),
                s = $(this).val().length;
            $(".site-inner-navbar > li").each(function() {
                var d = $(this).attr("data-username");
                if (d) var i = d.toLowerCase();
                if (i) {
                    -1 !== i.indexOf(e) ? $(this).show() : $(this).hide(), s > 0 ? $(".site-menu-caption").hide() : $(".site-menu-caption").show()
                }
            })
            ...
            width: "100%"
        }), !$(".site-navbar").hasClass("theme-horizontal")) {
        var o = $(window)[0].innerWidth;
        o < 992 || $(".site-navbar").hasClass("menupos-static") ? $(".navbar-content").slimScroll({
            setTop: "1px",
            size: "5px",
            wheelStep: 10,
            touchScrollStep: 90,
...
$(window).scroll(function() {
    ...
    var s = (this.attr("id"), {
        ...
        d = {
            ...
            HandleSubMenuTrigger: function() {
                var s = $(window),
                    d = s.width();
                if (1 == $(".site-navbar").hasClass("theme-horizontal"))
                    if (d >= 768) {
                        var i = $(".site-inner-navbar .site-submenu > li.site-hasmenu");
                        i.off("click").off("mouseenter mouseleave").hover(function() {
                            $(this).addClass("site-trigger")
                        }, function() {
                            $(this).removeClass("site-trigger")
                        })
                    } else {
                        var i = $(".site-inner-navbar .site-submenu > li > .site-submenu > li");
                        i.off("mouseenter mouseleave").off("click").on("click", function() {
                            0 === $(this).closest(".site-submenu").length ? $(this).hasClass("site-trigger") ? ($(this).removeClass("site-trigger"), $(this).children(".site-submenu").slideUp()) : ($(".site-submenu > li > .site-submenu > li.site-trigger").children(".site-submenu").slideUp(), $(this).closest(".site-inner-navbar").find("li.site-trigger").removeClass("site-trigger"), $(this).addClass("site-trigger"), $(this).children(".site-submenu").slideDown()) : $(this).hasClass("site-trigger") ? ($(this).removeClass("site-trigger"), $(this).children(".site-submenu").slideUp()) : ($(".site-submenu > li > .site-submenu > li.site-trigger").children(".site-submenu").slideUp(), $(this).closest(".site-submenu").find("li.site-trigger").removeClass("site-trigger"), $(this).addClass("site-trigger"), $(this).children(".site-submenu").slideDown())
                        }), $(".site-inner-navbar .site-submenu > li > .site-submenu > li").on("click", function(e) {
                            e.stopPropagation(), alert("click call"), 0 === $(this).closest(".site-submenu").length ? $(this).hasClass("site-trigger") ? ($(this).removeClass("site-trigger"), $(this).children(".site-submenu").slideUp()) : ($(".site-hasmenu li.site-trigger").children(".site-submenu").slideUp(), $(this).closest(".site-inner-navbar").find("li.site-trigger").removeClass("site-trigger"), $(this).addClass("site-trigger"), $(this).children(".site-submenu").slideDown()) : $(this).hasClass("site-trigger") ? ($(this).removeClass("site-trigger"), $(this).children(".site-submenu").slideUp()) : ($(".site-hasmenu li.site-trigger").children(".site-submenu").slideUp(), $(this).closest(".site-submenu").find("li.site-trigger").removeClass("site-trigger"), $(this).addClass("site-trigger"), $(this).children(".site-submenu").slideDown())
                        })
                    } switch (e.SubMenuTrigger) {
                    case "click":
                        $(".site-navbar .site-hasmenu").removeClass("is-hover"), $(".site-inner-navbar .site-submenu > li > .site-submenu > li").on("click", function(e) {
                            e.stopPropagation(), 0 === $(this).closest(".site-submenu").length ? $(this).hasClass("site-trigger") ? ($(this).removeClass("site-trigger"), $(this).children(".site-submenu").slideUp()) : ($(".site-submenu > li > .site-submenu > li.site-trigger").children(".site-submenu").slideUp(), $(this).closest(".site-inner-navbar").find("li.site-trigger").removeClass("site-trigger"), $(this).addClass("site-trigger"), $(this).children(".site-submenu").slideDown()) : $(this).hasClass("site-trigger") ? ($(this).removeClass("site-trigger"), $(this).children(".site-submenu").slideUp()) : ($(".site-submenu > li > .site-submenu > li.site-trigger").children(".site-submenu").slideUp(), $(this).closest(".site-submenu").find("li.site-trigger").removeClass("site-trigger"), $(this).addClass("site-trigger"), $(this).children(".site-submenu").slideDown())
                        }), $(".site-submenu > li").on("click", function(e) {
                            e.stopPropagation(), 0 === $(this).closest(".site-submenu").length ? $(this).hasClass("site-trigger") ? ($(this).removeClass("site-trigger"), $(this).children(".site-submenu").slideUp()) : ($(".site-hasmenu li.site-trigger").children(".site-submenu").slideUp(), $(this).closest(".site-inner-navbar").find("li.site-trigger").removeClass("site-trigger"), $(this).addClass("site-trigger"), $(this).children(".site-submenu").slideDown()) : $(this).hasClass("site-trigger") ? ($(this).removeClass("site-trigger"), $(this).children(".site-submenu").slideUp()) : ($(".site-hasmenu li.site-trigger").children(".site-submenu").slideUp(), $(this).closest(".site-submenu").find("li.site-trigger").removeClass("site-trigger"), $(this).addClass("site-trigger"), $(this).children(".site-submenu").slideDown())
                        })
                }
            },
            HandleMenuTrigger: function() {
                var s = $(window),
                    d = s.width();
                if (1 == $(".site-navbar").hasClass("theme-horizontal")) {
                    var i = $(".site-inner-navbar > li");
                    d >= 768 ? i.off("click").off("mouseenter mouseleave").hover(function() {
                        if ($(this).addClass("site-trigger"), $(".site-submenu", this).length) {
                            var e = $(".site-submenu:first", this),
                                s = e.offset(),
                                d = s.left,
                                i = e.width();
                            $(window).height();
                        ...
                        $(this).hasClass("site-trigger") ? ($(this).removeClass("site-trigger"), $(this).children(".site-submenu").slideUp()) : ($("li.site-trigger").children(".site-submenu").slideUp(), $(this).closest(".site-inner-navbar").find("li.site-trigger").removeClass("site-trigger"), $(this).addClass("site-trigger"), $(this).children(".site-submenu").slideDown())
                    })
                }
                switch (e.MenuTrigger) {
                    case "click":
                        $(".site-navbar").removeClass("is-hover"), $(".site-inner-navbar > li:not(.site-menu-caption) ").on("click", function() {
                            $(this).hasClass("site-trigger") ? ($(this).removeClass("site-trigger"), $(this).children(".site-submenu").slideUp()) : ($("li.site-trigger").children(".site-submenu").slideUp(), $(this).closest(".site-inner-navbar").find("li.site-trigger").removeClass("site-trigger"), $(this).addClass("site-trigger"), $(this).children(".site-submenu").slideDown())
                        })
                }
            },
            HandleOffset: function() {
                switch (e.themelayout) {
                    case "horizontal":
                        "hover" === e.SubMenuTrigger ? $("li.site-hasmenu").on("mouseenter mouseleave", function(e) {
                            if ($(".site-submenu", this).length) {
                                var s = $(".site-submenu:first", this),
                                    d = s.offset(),
                                    i = d.left,
                                    o = s.width();
                                $(window).height();
                        ...
                        }) : $("li.site-hasmenu").on("click", function(e) {
                            if (e.preventDefault(), $(".site-submenu", this).length) {
                                var s = $(".site-submenu:first", this),
                                    d = s.offset(),
                                    i = d.left,
                                    o = s.width();
    ...
    $(window)[0].innerWidth < 992 && ($(".site-navbar").toggleClass("mob-open"), e.stopPropagation())
}), $(window).ready(function() {
    var e = $(window)[0].innerWidth;
    $(".site-navbar").on("click tap", function(e) {
        e.stopPropagation()
    }), $(".site-main-container,.site-header").on("click", function() {
        e < 992 && 1 == $(".site-navbar").hasClass("mob-open") && ($(".site-navbar").removeClass("mob-open"), $("#mobile-collapse,#mobile-collapse1").removeClass("on"))
