...
<div class="col-md-12 px-0 mt-0">
  ...
  <div class="card-body px-0 pt-0">
    ...
    <div class="row">
      ...
      <div class="col-6 col-md-4 form-group">
        {!! Form::label('principal_insurer_1', 'Principal Insurer 1') !!}
				{!! Form::text('principal_insurer_1', null, ['id' => 'd5s534', 'class' => 'form-control']) !!}
      </div>

      <div class="col-6 col-md-4 form-group">
        {!! Form::label('principal_insurer_2', 'Principal Insurer 2') !!}
				{!! Form::text('principal_insurer_2', null, ['id' => 'd5s5g34', 'class' => 'form-control']) !!}
      </div>

      <div class="col-6 col-md-4 form-group">
        {!! Form::label('principal_insurer_3', 'Principal Insurer 3') !!}
