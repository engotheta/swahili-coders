...
<head>
    ...
    <style rel="stylesheet">
        :root {
            --order:1.5; 
            --primary-color:#23292e;
            --secondary-color:#008f49;

            --primary-color-dark:#21262b;
            --primary-color-light:#2b3136;
            --secondary-color-dark:#078045;
        ...
        .site-navbar a.nav-link:hover, .site-navbar a.nav-link:active{
            /* color:var(--secondary-color); */
            /* color:var(--secondary-color-dark) !important; */
        }
        .site-navbar .site-submenu{
...
@else
    ...
    <nav class="site-navbar bg-site-dark">
    ...
    <div class="site-main-container">
        <div class="site-wrapper">
            <div class="site-content">
                <div class="site-inner-content position-relative">
