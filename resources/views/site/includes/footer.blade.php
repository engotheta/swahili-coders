...
<footer class="site-footer parallax-banner  pb-0 pt-5  position-relative"
  ...
  <div class="bg-gradient-transparent-secondary h-100 w-100 bg position-absolute top-left"> </div>

  <div class="main-container container px-lg-5">
    <div class="row pb-3">

        <div class="col-md-5 text-center text-lg-left  has-shifting-underline">
        ...
        <div class="col-md-4 no-padding-sm text-center pl-lg-4 mt-4 mt-md-0 text-lg-left has-shifting-underline">
          <h6 class="footer-heading position-relative text-white d-inline-block pb-2 mb-4 text-uppercase">
    ...
    <span class="scroll-to-top has-hover-bounce bg-none border-0 text-white cursor-pointer  " style="transform:translateY(0px)">
      <div class="p-2 round d-flex justify-content-center position-relative align-items-center box-60">
        ...
        <span class="d-inline-block box-40 position-relative z-index-2" style="transform: scaleY(-1); top:-10px">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 90.55 50.67" class="hover-bounce" ><polygon class="stroke-primary" points="45.27 17.54 1.97 1.97 45.27 48.69 88.58 1.97 45.27 17.54"/></svg>
        </span>
      </div> 
    </span>
