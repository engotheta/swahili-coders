                    ...
                    <div class="col-12 ">
                        ...
                        <div class="row">
                            @foreach($fields as $key => $field)
                                @if(isset($licensedEntity[$field]) && trim($licensedEntity[$field])!=null && 
                                !(substr_count($licensedEntity[$field],0) == 8) && !($licensedEntity[$field] == 0) )
                                    <div class="col-md-12 last-no-border py-2 border-bottom-faded ">
                                        <div class="faded text-capitalize">{{str_replace("_", " ", $field)}}</div>
                                        <div class="text-dark mt-0"> {{str_replace("_", " ", $licensedEntity[$field])}} </div>
                                    </div>
                                @endif
                            @endforeach
                        </div>
