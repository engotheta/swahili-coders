...
<head>
  ...
  @include('site.includes.loader_css')
  @yield('css-content')
...
<body>
  <div class="container max-1920 px-0">
    ...
    <!-- /HEADER -->
      ...
      @if($preference->show_loading)
        <div class="position-fixed loader flex-centerish  h-100 w-100" style=" z-index:9999; background:rgba(255, 255, 255, 0.99)">
          <div class="loader-11 position-relative" style="top:-100px !important"></div>
        </div>
      @endif
    
      <!-- contents -->
      <div  @if($preference->show_loading) class="page-content-container d-none move-up " style="--order:1.5" @endif>
        @yield('content')
      </div>
     <!-- /contents -->
