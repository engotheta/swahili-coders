...
class ProjectsController extends BaseController {
    ...
    public function store(Request $request)
    {
        ...
        if ($request->get('icon')) {
            ...
            $file_url_en = $request->file('icon');

            $doc_name_en = 'icon-'.time() . '-' .$file_url_en->getClientOriginalName();
    ...
    public function update(Request $request, $id)
    {
        ...
        if($request->file('icon')){  
                ...
                if(is_file(public_path().'/uploads/projects/'.$project->icon) && file_exists(public_path().'/uploads/projects/'.$project->icon)){
                    unlink(public_path().'/uploads/projects/'.$project->icon);
                }
